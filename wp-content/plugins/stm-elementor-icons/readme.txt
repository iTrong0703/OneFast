...
STM Elementor Icons is a free WordPress plugin allowing its users to upload unlimited custom icons to their websites.
...
* STM Elementor Icons allows you to add unlimited icons to your website. The plugin supports compatibility with different services, such as IcoMoon, which will help you to generate icon fonts. This service allows you to create and save your own icon sets, either from pre-built icon packs or from your custom SVG icons.
...
## Simple work with the STM Elementor Icons plugin
