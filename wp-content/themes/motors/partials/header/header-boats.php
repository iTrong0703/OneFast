...
<div class="header-listing header-listing-boats <?php echo esc_attr( $fixed_header_class . ' ' . $transparent_header_class ); ?>">
	...
	<div class="container header-inner-content">
		...
		<div class="listing-service-right clearfix" style="<?php echo apply_filters( 'stm_me_wpcfto_parse_spacing', '', $menu_icon_top_margin ); //phpcs:ignore ?>">
			...
			<ul class="listing-menu boats-menu-<?php echo ( wp_is_mobile() ) ? 'ipad' : 'desktop'; ?> clearfix" style="<?php echo apply_filters( 'stm_me_wpcfto_parse_spacing', '', $menu_top_margin );//phpcs:ignore ?>">
				<?php
