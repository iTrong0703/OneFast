	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<div class="labeled"><?php esc_html_e( 'Vehicle price', 'motors' ); ?> <span class="orange">(<?php echo $currency_symbol;//phpcs:ignore ?>)</span></div>
			...
			<!--Down Payment-->
			<div class="form-group">
				<div class="labeled"><?php esc_html_e( 'Down Payment', 'motors' ); ?> <span class="orange">(<?php echo $currency_symbol;//phpcs:ignore ?>)</span></div>
